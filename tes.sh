...
# Install Template
wget -q -O /usr/local/bin/ws-drop "https://raw.githubusercontent.com/basir96/scvip/ipuk/CDN/ws-dropbear.py"
wget -q -O /usr/local/bin/ws-openssh "https://raw.githubusercontent.com/basir96/scvip/ipuk/CDN/ws-openssh.py"
wget -q -O /usr/local/bin/ws-ovpn "https://raw.githubusercontent.com/basir96/scvip/ipuk/CDN/ws-ovpn.py"
wget -q -O /usr/local/bin/ws-tls "https://raw.githubusercontent.com/basir96/scvip/ipuk/CDN/ws-tls.py"
